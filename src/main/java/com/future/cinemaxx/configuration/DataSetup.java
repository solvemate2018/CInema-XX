...
public class DataSetup implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Projection projection15 = projectionRepo.save(new Projection(LocalDateTime.now().plusDays(1), 15.6f, cinemaHall5, movie6));
        Projection projection16 = projectionRepo.save(new Projection(LocalDateTime.now().plusDays(1), 15.6f, cinemaHall5, movie6));
        Projection projection17 = projectionRepo.save(new Projection(LocalDateTime.now().plusDays(10), 15.6f, cinemaHall4, movie7));
